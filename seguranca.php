...
function validaUsuario($usuario, $senha)
{
  ...
  if (empty($resultado)) {
    ...
    setcookie('SID', $sga_usuarios_ID, time() + 3600); // Pega o valor da coluna 'id do registro encontrado no MySQL
    setcookie('UID',  $sga_usuarios_Login, time() + 3600); // Pega o valor da coluna 'nome' do registro encontrado no MySQL
    setcookie('Nome', $sga_usuarios_Nome, time() + 3600);
