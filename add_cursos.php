                ...
                <div class="container-fluid">
                    <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form name="cad_curso" action="inserir_curso.php" method="post">
        <fieldset>
          <!-- Text input-->
          <div class="form-group">
<label class="col-sm-2 control-label">Nome do Curso</label>
<div class="col-sm-10">
  <input name="nomeCurso" id="nomeCurso"  class="form-control" type="text" required placeholder = "Curso xxx">
...
<div class="form-group">
            ...
            <div class="col-sm-10">
            <input class="col-sm-1" type="number" id="duracao" name="duracao" required placeholder="1" > &nbsp;&nbsp;&nbsp; Semestre(s)
</div> 
</div>
