            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li><a href="add_aulas.php"><i class="ti-pencil-alt"></i> Lançar Aulas</a></li>
                        ...
                        <li><a class="sidebar-sub-toggle"><i class="ti-book"></i> Diários <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                            <li><a href="add_diarios.php">Cadastrar Diários </a></li>
                            ...
                            <ul>
                            <li><a href="add_cursos.php">Cadastrar Cursos </a></li>
                            <li><a href="rel_cursos.php">Cursos Cadastrados</a></li>
                            </ul>

                            <li><a class="sidebar-sub-toggle"><i class="ti-bookmark"></i> Disciplinas <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                            <li><a href="add_disciplinas.php">Cadastrar Disciplinas </a></li>
                            <li><a href="rel_disciplinas.php">Disciplinas Cadastradas</a></li>
                            </ul>


                            <li><a class="sidebar-sub-toggle"><i class="ti-user"></i> Alunos <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                            <li><a href="add_alunos.php">Cadastrar Alunos </a></li>
                            <li><a href="rel_alunos.php">Alunos Cadastrados</a></li>
                            </ul>
                            <li><a href="matricular.php"><i class="ti-check-box"></i> Matricular Alunos No Diário</a>
